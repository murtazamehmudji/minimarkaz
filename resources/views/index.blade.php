        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 col-12">
                <div class="section-heading left-holder mt-15">
                    <h4 class="bold">Where creativity meets technology. Open up your business to new possibilities.
                    </h4>
                    <div class="section-heading-line"></div>
                </div>
                    ...
                    <div class="col-md-4 col-sm-4 col-12">
                        <div class="pie-chart">
                            <div class="chart-percent"><span class="chart" data-percent="70" data-width="2"
                                    data-size="120" data-color="#2387ea"><span class="percent"></span></span></div>
                            <h4>Content Marketing</h4>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-12">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-sm-10 col-12 offset-md-6">
                ...
                <div class="mt-30"><a href="#" class="primary-button button-sm">Contact Us</a></div>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-md-5 col-sm-6 col-12">
                <div class="contact-form-md white-background shadow-primary">
                    ...
                    <form method="get" action="#" class="mt-30"><input type="text" name="name"
                            ...
                            placeholder="Your Email"><textarea name="message"
                            placeholder="Your Message"></textarea><button type="submit"
