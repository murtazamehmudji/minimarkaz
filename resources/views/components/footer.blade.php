        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-12">
                ...
                <ul class="footer-style-1-contact-info">
                    ...
                    <li><i class="fa fa-envelope-open"></i> <span>info@minimarkaz.com</span></li>
                    <li><i class="fa fa-map-marker-alt"></i> <span>Jamat ka bagh, Bilotipura, Ujjain - 456006</span></li>
