...
@section('content')
    <div class="page-title jarallax black-overlay-20" data-jarallax data-speed="0.6"
        ...
        <div class="container">
            <h1>Unlimited Shared Hosting</h1>
            <ul>
                <li><a href="{{ route('home') }}">Home</a></li>
                <li><a href="{{ route('home') }}">Hosting</a></li>
                <li><a href="{{ route('hosting_shared') }}">Unlimited Shared Hosting</a></li>
            </ul>
        </div>
    </div>
    <div class="section-block">
        <div class="container">
            <div class="section-heading center-holder">
                <h3 class="bold">Best Cheap <span class="italic libre-baskerville primary-color">Unlimited Shared Webhosting</span> For your Websites</h3>
                <div class="section-heading-line"></div>
                <p>Don't waste money only because of Brand name ! Check our Unlimited Webhosting Plans with Faster Server Speed comes with Free SSL | Weekly Backups | Popular Control Panel | LiteSpeed PHP API | Website Builder and More, India's Best Unlimited Webhosting Service Provider Since 2013</p>
            </div>
            {{-- <div class="row mt-50">
